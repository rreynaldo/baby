...
class ListCommand extends Command
{
  ...
  {
    $this
      ->setName("baby:scheduler-list")
      ->setDescription("List the existing schedules")
      ->setHelp("This command display the list of registered schedules.")
